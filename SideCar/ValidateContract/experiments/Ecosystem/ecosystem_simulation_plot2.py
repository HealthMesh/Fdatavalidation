...
def duplicate_policies(graph, original_policy_uri, data_contract_uri, n):
    for i in range(n):
        ...
        print("NEW POLICY", new_policy_uri)
...
if __name__ == "__main__":
    ...
    for i in range(NDPolicies):
        ...
        for dp in dps:
            ...
            ecosystem = duplicate_policies(ecosystem, abox["p1"], dc, NDPolicies)
        ...
        ecosystem.serialize(destination='ecosystem_policies_after.ttl', format='turtle')
